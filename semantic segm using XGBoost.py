# -*- coding: utf-8 -*-
"""
Created on Fri May 27 09:51:15 2022
...
print(os.listdir("C:/deep/projects/semantic segm XGBoost"))
...
y_train = train_masks
y_train = np.expand_dims(y_train, axis=1) #May not be necessary.. leftover from previous code 
